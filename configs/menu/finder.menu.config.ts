...
export const finderMenuConfig = createMenuConfig({
  ...
  window: {
    ...
    menu: {
      ...
      'open-iterminal-here': {
        title: 'Open iTerminal Here',
      },
      'open-git-bash-here': {
        title: 'Open Git Bash Here',
      },
      'open-git-gui-here': {
        title: 'Open Git GUI Here',
      },
      'open-folder-as-pycharm-community-edition-project': {
        title: 'Open Folder as PyCharm Community Edition Project',
      },
      'open-folder-as-pycharm-professional-edition-project': {
        title: 'Open Folder as Pycharm Professional Edition Project',
      },
      'open-folder-as-visual-studio-project': {
        title: 'Open Folder as Visual Studio Project',
      },
      'open-with-code': {
        title: 'Open with Code',
      },
      'open-folder-as-xcode-project': {
        title: 'Open Folder as XCode Project',
      },
      'open-android-studio': {
