<script lang="ts">
  ...
  let progressVal = tweened(100, { duration: 8000, easing: quintInOut });
...
{#if !(hiddenSplashScreen || import.meta.env.DEV)}
  <div out:fadeOut={{ duration: 500 }} class="splash-screen" use:elevation={'bootup-screen'}>
    ...
    <div
      ...
      aria-valuemin={0}
      aria-valuemax={100}
      aria-valuetext="Loading up MacOS..."
    >
...
{#if import.meta.env.PROD}
  <iframe id="audio" src="/sounds/mac-startup-sound.mp3" allow="autoplay" title="Mac" />
{/if}
