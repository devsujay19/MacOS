...
<SystemDialog bind:this={themeWarningDialog} on:close={() => (isThemeWarningDialogOpen = false)}>
  <section class="theme-warning-section">
    ...
    <h3>Current Wallpaper Settings is preventing to change the theme</h3>
    <p>Go to the Wallpapers app to change this setting or choose a standalone wallpaper.</p>
